...
<html>
<title><%=languageResources.getResource(Constants.TITLE)%></title>
<head>
...
<!--  
<form action="CityLibraryWeb/menu" method="post">
<button type="submit"languageResources.getResource(Constants.CHANGE_LANGUAGE)GE) %></button>
</form>-->
